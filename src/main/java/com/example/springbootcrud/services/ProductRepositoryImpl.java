...
public class ProductRepositoryImpl implements ProductRepository {
    ...
    @Override
    public List<Products> findByPrice(int price) {
        return null;
    }

    @Override
    public List<Products> findByNameStartingWith(String name) {
        return null;
    }

    @Override
    public List<Products> OrderByPrice(int price1, int price2) {
        return null;
    }
